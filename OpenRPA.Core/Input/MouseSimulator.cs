...
namespace OpenRPA.Input
{
    public static class MouseSimulator
    {
        ...
        public static void MouseButton(MouseButton button)
        {
            if (button == Interfaces.MouseButton.Left)
            {
                ClickLeftMouseButton();
            }
            else if (button == Interfaces.MouseButton.Middle)
            {
                ClickMiddelMouseButton();
            }
            else
            {
