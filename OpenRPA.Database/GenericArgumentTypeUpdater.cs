...
namespace OpenRPA.Database
{
    ...
    public static class GenericArgumentTypeUpdater
    {
        ...
        {
            System.Activities.Activity activity = (System.Activities.Activity)Activator.CreateInstance(activityType);
        ...
        private static void UpdateTypeArgument(ModelItem modelItem, Int32 argumentIndex, Type newGenericType)
        {
            ...
            using (ModelEditingScope editingScope = newModelItem.BeginEdit("Change type argument"))
            {
                ...
                if (itemType.IsSubclassOf(typeof(System.Activities.Activity)) && newType.IsSubclassOf(typeof(System.Activities.Activity)))
                {
